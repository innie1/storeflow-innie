...
// Flow responses use a tiny local markdown renderer so **bold** and bullet points
// are presented as real UI instead of exposing formatting syntax to the merchant.
