  ...
  return (
    <section className="rounded-2xl border border-border bg-card p-4 text-left">
      <div className="flex items-start justify-between gap-3">
        <div><p className="text-[11px] font-black uppercase text-primary">Machines & methods</p><h2 className="mt-1 font-display font-black">Laundry equipment usage</h2><p className="mt-1 text-xs text-muted-foreground">Pick the washer, dryer or hand-wash used on each job.</p></div>
